...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!isset($error_message)) {
    ...
    $mail->Username = "jsaucedo.developer@gmail.com";
    //Password to use for SMTP authentication
    $mail->Password = "pitkvhniiherwhpl";


    //Set who the message is to be sent from
    $mail->setFrom('jsaucedo.developer@gmail.com', 'Jorge Saucedo');
    //Set an alternative reply-to address
    $mail->addReplyTo($email, $name);
    //Set who the message is to be sent to
    $mail->addAddress('jsaucedo.developer@gmail.com', 'Jorge Saucedo');
    ...
    <form action="suggest.php" method="post">
      <table>
        ...
        <tr style="display: none">
          ...
          <td><input type="text" id="address" name="adress" /><p>Please, leave this field blank</p></td>
        </tr>
      </table>
